...
(function($)
{
    ...
    {
        screen_speed:     200,   // Speed of the black screen's fading in/out
        popup_speed:      200,   // Speed of the popup's fading in/out (no effect in IE)
        transition_speed: 200,   // Speed of loading the content, and going from one screen to another
        delay:            100,   // Delay in AJAX loading time
        allow_clickout:   true,  // Allow clicking on the background to close
        screen_opacity:   0.9,   // Opacity of the black screen (0...1)
